...
public final class ItemChatUserBinding implements ViewBinding {
  ...
  private ItemChatUserBinding(@NonNull ConstraintLayout rootView, @NonNull TextView tvMessage) {
  ...
  public static ItemChatUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemChatUserBinding((ConstraintLayout) rootView, tvMessage);
    }
