...
public final class ItemChatAiBinding implements ViewBinding {
  ...
  private ItemChatAiBinding(@NonNull ConstraintLayout rootView, @NonNull TextView tvMessage) {
  ...
  public static ItemChatAiBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemChatAiBinding((ConstraintLayout) rootView, tvMessage);
    }
